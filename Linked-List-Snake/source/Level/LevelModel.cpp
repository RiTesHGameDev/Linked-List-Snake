...
namespace Level
{
	...
	void LevelModel::initializeLevelData()
	{
		...
		level_configurations.push_back(LevelData(Level::LevelNumber::THREE, &level_three_elementlist));
		level_configurations.push_back(LevelData(Level::LevelNumber::FOUR, &level_four_elementlist));
	}
